  ...
  function renderFrames(notificationType)
  {
    ...
    return Promise.all([loadImage("icons/abp-19.png"), loadImage("icons/abp-19-whitelisted.png"), loadImage("icons/abp-19-notification-" + notificationType + ".png"), loadImage("icons/abp-38.png"), loadImage("icons/abp-38-whitelisted.png"), loadImage("icons/abp-38-notification-" + notificationType + ".png")]).then(function(images)
    {
      ...
      for (var _loopIndex12 = 0; _loopIndex12 < [false, true].length; ++_loopIndex12)
      {
        ...
        {
          var imageData = {};
          for (var _loopIndex13 = 0; _loopIndex13 < [19, 38].length; ++_loopIndex13)
          {
            var size = [19, 38][_loopIndex13];
            canvas.width = size;
            canvas.height = size;
...
require.scopes["requestBlocker"] = (function()
{
  ...
  var BlockingFilter = _tempVar21.BlockingFilter;
  var Subscription = require("subscriptionClasses").Subscription;
  var defaultMatcher = require("matcher").defaultMatcher;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Prefs = require("prefs").Prefs;
  var _tempVar22 = require("whitelisting");
  var checkWhitelisted = _tempVar22.checkWhitelisted;
  var getKey = _tempVar22.getKey;
  ...
  port.on("filters.collapse", function(message, sender)
  {
    ...
    for (var _loopIndex24 = 0; _loopIndex24 < message.urls.length; ++_loopIndex24)
    {
      var url = message.urls[_loopIndex24];
...
require.scopes["subscriptionInit"] = (function()
{
  "use strict";
  var exports = {};
  var _tempVar25 = require("subscriptionClasses");
  var Subscription = _tempVar25.Subscription;
  var DownloadableSubscription = _tempVar25.DownloadableSubscription;
  var SpecialSubscription = _tempVar25.SpecialSubscription;
  var FilterStorage = require("filterStorage").FilterStorage;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Prefs = require("prefs").Prefs;
  ...
  {
    for (var _loopIndex26 = 0; _loopIndex26 < FilterStorage.subscriptions.length; ++_loopIndex26)
    {
      var subscription = FilterStorage.subscriptions[_loopIndex26];
  ...
  {
    var subscriptions = [];
    for (var _loopIndex27 = 0; _loopIndex27 < Prefs.additional_subscriptions.length; ++_loopIndex27)
    {
      var url = Prefs.additional_subscriptions[_loopIndex27];
  ...
  function finishInitialization(subscriptions)
  {
    ...
    for (var _loopIndex28 = 0; _loopIndex28 < subscriptions.length; ++_loopIndex28)
    {
      var subscription = subscriptions[_loopIndex28];
...
require.scopes["uninstall"] = (function()
{
  ...
  function setUninstallURL()
  {
    ...
    for (var _loopIndex29 = 0; _loopIndex29 < keys.length; ++_loopIndex29)
    {
      var key = keys[_loopIndex29];
...
require.scopes["whitelisting"] = (function()
{
  ...
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var _tempVar30 = require("url");
  var stringifyURL = _tempVar30.stringifyURL;
  var getDecodedHostname = _tempVar30.getDecodedHostname;
  var extractHostFromFrame = _tempVar30.extractHostFromFrame;
  var isThirdParty = _tempVar30.isThirdParty;
  var port = require("messaging").port;
  var devtools = require("devtools");
  ...
  FilterNotifier.on("filter.behaviorChanged", function()
  {
    ...
    {}, function(pages)
    {
      for (var _loopIndex31 = 0; _loopIndex31 < pages.length; ++_loopIndex31)
      {
        var page = pages[_loopIndex31];
  ...
  function onHeadersReceived(details)
  {
    ...
    for (var _loopIndex32 = 0; _loopIndex32 < details.responseHeaders.length; ++_loopIndex32)
    {
      var header = details.responseHeaders[_loopIndex32];
...
require.scopes["antiadblockInit"] = (function()
{
  ...
  exports.initAntiAdblockNotification = function initAntiAdblockNotification()
  {
    ...
    {
      var urlFilters = [];
      for (var _loopIndex33 = 0; _loopIndex33 < subscription.filters.length; ++_loopIndex33)
      {
        var filter = subscription.filters[_loopIndex33];
...
require.scopes["cssRules"] = (function()
{
  ...
  var CSSRules = exports.CSSRules = {
    ...
    getRulesForDomain: function(domain)
    {
      ...
      for (var _loopIndex34 = 0; _loopIndex34 < keys.length; ++_loopIndex34)
      {
        var key = keys[_loopIndex34];
...
require.scopes["downloader"] = (function()
{
  ...
  Downloader.prototype = {
    ...
    {
      var now = Date.now();
      for (var _loopIndex35 = 0; _loopIndex35 < this.dataSource().length; ++_loopIndex35)
      {
        var downloadable = this.dataSource()[_loopIndex35];
...
require.scopes["elemHide"] = (function()
{
  ...
  var ElemHide = exports.ElemHide = {
    ...
    getSelectorsForDomain: function(domain, specificOnly)
    {
      ...
      for (var _loopIndex38 = 0; _loopIndex38 < keys.length; ++_loopIndex38)
      {
        var key = keys[_loopIndex38];
        var filter = filterByKey[key];
...
require.scopes["events"] = (function()
{
  ...
  exports.EventEmitter.prototype = {
    ...
    emit: function(name)
    {
      ...
      for (var _loopIndex39 = 0; _loopIndex39 < listeners.length; ++_loopIndex39)
      {
        var listener = listeners[_loopIndex39];
...
require.scopes["filterClasses"] = (function()
{
  ...
  Filter.normalize = function(text)
  {
    ...
    {
      var _tempVar40 = /^(.*?)(#\@?#?)(.*)$/.exec(text);
      var domain = _tempVar40[1];
      var separator = _tempVar40[2];
      var selector = _tempVar40[3];
  ...
  RegExpFilter.fromText = function(text)
  {
    ...
    if (match)
    {
      ...
      for (var _loopIndex41 = 0; _loopIndex41 < options.length; ++_loopIndex41)
      {
        var option = options[_loopIndex41];
        var value = null;
  ...
  ElemHideBase.fromText = function(text, domain, isException, tagName, attrRules, selector)
  {
    if (!selector)
    {
      ...
      if (attrRules)
      {
        ...
        for (var _loopIndex42 = 0; _loopIndex42 < attrRules.length; ++_loopIndex42)
        {
          var rule = attrRules[_loopIndex42];
...
require.scopes["filterListener"] = (function()
{
  ...
  var defaultMatcher = require("matcher").defaultMatcher;
  var _tempVar43 = require("filterClasses");
  var ActiveFilter = _tempVar43.ActiveFilter;
  var RegExpFilter = _tempVar43.RegExpFilter;
  var ElemHideBase = _tempVar43.ElemHideBase;
  var CSSPropertyFilter = _tempVar43.CSSPropertyFilter;
  var Prefs = require("prefs").Prefs;
  var batchMode = false;
  var isDirty = 0;
  var FilterListener = {
  ...
  function onLoad()
  {
    ...
    ElemHide.clear();
    CSSRules.clear();
    for (var _loopIndex44 = 0; _loopIndex44 < FilterStorage.subscriptions.length; ++_loopIndex44)
    {
      var subscription = FilterStorage.subscriptions[_loopIndex44];
      if (!subscription.disabled)
      {
        subscription.filters.forEach(addFilter);
      }
...
require.scopes["filterStorage"] = (function()
{
  ...
  var ActiveFilter = _tempVar45.ActiveFilter;
  var _tempVar46 = require("subscriptionClasses");
  var Subscription = _tempVar46.Subscription;
  var SpecialSubscription = _tempVar46.SpecialSubscription;
  var ExternalSubscription = _tempVar46.ExternalSubscription;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Utils = require("utils").Utils;
  var formatVersion = 4;
  var FilterStorage = exports.FilterStorage = {
    ...
    resetHitCounts: function(filters)
    {
      ...
      for (var _loopIndex48 = 0; _loopIndex48 < filters.length; ++_loopIndex48)
      {
        var filter = filters[_loopIndex48];
        filter.hitCount = 0;
        filter.lastHit = 0;
      }
    },
      ...
      var readFile = function(sourceFile, backupIndex)
      {
        ...
        IO.readFromFile(sourceFile, parser, function(e)
        {
          ...
          if (e && !explicitFile)
          {
            ...
            if (sourceFile)
            {
              var _tempVar49 = /^(.*)(\.\w+)$/.exec(sourceFile.leafName) || [null, sourceFile.leafName, ""];
      ...
      var checkBackupRequired = function(callbackNotRequired, callbackRequired)
      {
        ...
        else
        {
          IO.statFile(targetFile, function(e, statData)
          {
            ...
            {
              var _tempVar50 = /^(.*)(\.\w+)$/.exec(targetFile.leafName) || [null, targetFile.leafName, ""];
    ...
    {
      var result = [];
      var _tempVar51 = /^(.*)(\.\w+)$/.exec(FilterStorage.sourceFile.leafName) || [null, FilterStorage.sourceFile.leafName, ""];
      var part1 = _tempVar51[1];
      var part2 = _tempVar51[2];
      for (var i = 1;; i++)
      {
  ...
  function removeSubscriptionFilters(subscription)
  {
    ...
    for (var _loopIndex53 = 0; _loopIndex53 < subscription.filters.length; ++_loopIndex53)
    {
      var filter = subscription.filters[_loopIndex53];
          ...
          if (this.curObj)
          {
            ...
            case "subscription patterns":
              if (this.subscriptions.length)
              {
                ...
                for (var _loopIndex54 = 0; _loopIndex54 < this.curObj.length; ++_loopIndex54)
                {
                  var text = this.curObj[_loopIndex54];
...
require.scopes["matcher"] = (function()
{
  ...
  CombinedMatcher.maxCacheEntries = 10000;
...
require.scopes["notification"] = (function()
{
  var exports = {};
  var Prefs = require("prefs").Prefs;
  var _tempVar56 = require("downloader");
  var Downloader = _tempVar56.Downloader;
  var Downloadable = _tempVar56.Downloadable;
  var MILLIS_IN_MINUTE = _tempVar56.MILLIS_IN_MINUTE;
  var MILLIS_IN_HOUR = _tempVar56.MILLIS_IN_HOUR;
  var MILLIS_IN_DAY = _tempVar56.MILLIS_IN_DAY;
  var Utils = require("utils").Utils;
  var _tempVar57 = require("matcher");
  var Matcher = _tempVar57.Matcher;
  var defaultMatcher = _tempVar57.defaultMatcher;
  var _tempVar58 = require("filterClasses");
  var Filter = _tempVar58.Filter;
  var RegExpFilter = _tempVar58.RegExpFilter;
  var WhitelistFilter = _tempVar58.WhitelistFilter;
  ...
  var Notification = exports.Notification = {
    ...
    _onDownloadSuccess: function(downloadable, responseText, errorCallback, redirectCallback)
    {
      try
      {
        ...
        for (var _loopIndex59 = 0; _loopIndex59 < data.notifications.length; ++_loopIndex59)
        {
          var notification = data.notifications[_loopIndex59];
      ...
      var _tempVar60 = downloader.processExpirationInterval(EXPIRATION_INTERVAL);
      Prefs.notificationdata.softExpiration = _tempVar60[0];
      Prefs.notificationdata.hardExpiration = _tempVar60[1];
    ...
    _getNextToShow: function(url)
    {
      ...
      var _tempVar61 = require("info");
      var addonName = _tempVar61.addonName;
      var addonVersion = _tempVar61.addonVersion;
      var application = _tempVar61.application;
      var applicationVersion = _tempVar61.applicationVersion;
      var platform = _tempVar61.platform;
      var platformVersion = _tempVar61.platformVersion;
      var notificationToShow = null;
      for (var _loopIndex62 = 0; _loopIndex62 < notifications.length; ++_loopIndex62)
      {
        var notification = notifications[_loopIndex62];
        ...
        if (typeof url === "string" || notification.urlFilters instanceof Array)
        {
          if (Prefs.enabled && typeof url === "string" && notification.urlFilters instanceof Array)
          {
            ...
            for (var _loopIndex63 = 0; _loopIndex63 < notification.urlFilters.length; ++_loopIndex63)
            {
              var urlFilter = notification.urlFilters[_loopIndex63];
        ...
        {
          var match = false;
          for (var _loopIndex64 = 0; _loopIndex64 < notification.targets.length; ++_loopIndex64)
          {
            var target = notification.targets[_loopIndex64];
    ...
    showNext: function(url)
    {
      ...
      if (notification)
      {
        for (var _loopIndex65 = 0; _loopIndex65 < showListeners.length; ++_loopIndex65)
        {
          var showListener = showListeners[_loopIndex65];
    ...
    getLocalizedTexts: function(notification, locale)
    {
      ...
      var localizedTexts = [];
      for (var _loopIndex66 = 0; _loopIndex66 < textKeys.length; ++_loopIndex66)
      {
        var key = textKeys[_loopIndex66];
    ...
    triggerQuestionListeners: function(id, approved)
    {
      ...
      for (var _loopIndex67 = 0; _loopIndex67 < listeners.length; ++_loopIndex67)
      {
        var listener = listeners[_loopIndex67];
        listener(approved);
      }
    },
...
{
  var exports = {};
  var _tempVar68 = require("filterClasses");
  var ActiveFilter = _tempVar68.ActiveFilter;
  var BlockingFilter = _tempVar68.BlockingFilter;
  var WhitelistFilter = _tempVar68.WhitelistFilter;
  var ElemHideBase = _tempVar68.ElemHideBase;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  ...
  Subscription.prototype = {
    ...
    {
      for (var _loopIndex69 = 0; _loopIndex69 < this.filters.length; ++_loopIndex69)
      {
        var filter = this.filters[_loopIndex69];
  ...
  SpecialSubscription.prototype = {
    ...
    isDefaultFor: function(filter)
    {
      ...
      {
        for (var _loopIndex70 = 0; _loopIndex70 < this.defaults.length; ++_loopIndex70)
        {
          var type = this.defaults[_loopIndex70];
...
{
  var exports = {};
  var _tempVar71 = require("downloader");
  var Downloader = _tempVar71.Downloader;
  var Downloadable = _tempVar71.Downloadable;
  var MILLIS_IN_SECOND = _tempVar71.MILLIS_IN_SECOND;
  var MILLIS_IN_MINUTE = _tempVar71.MILLIS_IN_MINUTE;
  var MILLIS_IN_HOUR = _tempVar71.MILLIS_IN_HOUR;
  var MILLIS_IN_DAY = _tempVar71.MILLIS_IN_DAY;
  var _tempVar72 = require("filterClasses");
  var Filter = _tempVar72.Filter;
  var CommentFilter = _tempVar72.CommentFilter;
  var FilterStorage = require("filterStorage").FilterStorage;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Prefs = require("prefs").Prefs;
  var _tempVar73 = require("subscriptionClasses");
  var Subscription = _tempVar73.Subscription;
  var DownloadableSubscription = _tempVar73.DownloadableSubscription;
  var Utils = require("utils").Utils;
  var INITIAL_DELAY = 1 * MILLIS_IN_MINUTE;
  var CHECK_INTERVAL = 1 * MILLIS_IN_HOUR;
  ...
  var Synchronizer = exports.Synchronizer = {
    ...
    _getDownloadables: function()
    {
      ...
      for (var _loopIndex74 = 0; _loopIndex74 < FilterStorage.subscriptions.length; ++_loopIndex74)
      {
        var subscription = FilterStorage.subscriptions[_loopIndex74];
    ...
    _onDownloadSuccess: function(downloadable, responseText, errorCallback, redirectCallback)
    {
      ...
      var _tempVar75 = downloader.processExpirationInterval(expirationInterval);
      var softExpiration = _tempVar75[0];
      var hardExpiration = _tempVar75[1];
      ...
      lines.shift();
      var filters = [];
      for (var _loopIndex76 = 0; _loopIndex76 < lines.length; ++_loopIndex76)
      {
        var line = lines[_loopIndex76];
